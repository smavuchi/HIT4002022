...
from app.services.api_resource.update import update_api_resource as _update_api_resource
...
route = router.routes["update an API resource"]
...
def update_api_resource(resource_id, api_id, **kwargs):
  ...
  result = _update_api_resource(resource, **kwargs)
