...
from app.services.api_dataset.get_data import get_data

route = router.routes["get dataset data"]
...
def action_get_dataset_data(api_id, resource_id, offset, limit, **kwargs):
  ...
  data = get_data(dataset, offset, limit)
