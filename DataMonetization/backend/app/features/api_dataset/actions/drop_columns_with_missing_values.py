...
from app.services.api_dataset.drop_columns_with_missing_values import drop_columns_with_missing_values as _drop_columns_with_missing_values

route = router.routes["resolve missing data by dropping columns"]
...
def drop_columns_with_missing_values(api_id, resource_id, min_percent, **kwargs):
  ...
  dataset = _drop_columns_with_missing_values(dataset, min_percent=min_percent)
