...
from app.services.api_dataset.set_id_columns import set_id_columns

from .__set_columns_params import parameters

route = router.routes["set id columns"]
...
def set_id_dataset_columns(api_id, resource_id, columns, **kwargs):
  ...
  dataset = set_id_columns(dataset, columns)
