                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card shadow mb-4 ">
                                <div class="card-header py-3">
                                    <h6 class="text-primary fw-bold m-0">Completed</h6>
                                </div>
                                <ul class="list-group list-group-flush">
                                    <?php
                                    $con = mysqli_connect("localhost", 'root', '', 'diagnoser');
                                    ...
                                    ?>
                                        <li class="list-group-item">
                                            <div class="row align-items-center no-gutters">
                                                ...
                                                <div class="col-auto"><a class="btn btn-secondary btn-icon-split" href="profile.php?id=<?php echo $row['id'] ?>" role="button"><span class="text-white-50 icon" style="--bs-success: #1cc88a;--bs-success-rgb: 28,200,138;background: var(--bs-green);font-size: 20px;color: rgb(255,255,255);"><i class="fas fa-check-circle" style="color: rgb(255,255,255);"></i></span><span class="text-white text">Open file</span></a></div>
                                            </div>
                                        </li>
                                    <?php
                                    }
